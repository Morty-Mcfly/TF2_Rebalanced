...
class ::TF_WEAPONS_BASE
{
	...
	constructor(TF_class, TF_slot, weapon, id, ammotype, prim, sec, world_model, view_model, extra_wearable, clearstats, Function, class_armz)
	{
		tf_class	= TF_class
		slot		= TF_slot
		className	= weapon
...
//-----------------------------------------------------------------------------
	...
	TF_WEAPONS(3, 1, "parachute_secondary", 1101, "B.A.S.E. Jumper Soldier", "Soldier Parachute", TF_AMMO.NONE, -1, -1, "models/workshop/weapons/c_models/c_paratooper_pack/c_paratrooper_pack.mdl")
...
//-----------------------------------------------------------------------------
	...
	TF_WEAPONS(4, 1, "parachute_primary", 1101, "B.A.S.E. Jumper Demo", "Demo Parachute", TF_AMMO.NONE, -1, -1, "models/workshop/weapons/c_models/c_paratooper_pack/c_paratrooper_pack.mdl")
